            ...
            <div className="w-full max-w-sm rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
              ...
              <div className="px-5 pb-5 py-4 ">
                ...
                <div className="flex justify-between items-center py-1">
                  <h1 className="font-bold text-xs mr-1  text-amber-100">
                    Genre
                  </h1>
                  <span className="text-xs font-bold mr-1  font-raleway uppercase px-2.5 rounded bg-gray-700 text-pink-600 ">
                    {artwork.genre}
                  </span>
                  <h1 className="font-bold text-xs mr-1 text-amber-100">
                    Canvas
                ...
                <div className="flex items-center justify-between">
                  <span className="text-l bg-gray-700 p-2 rounded font-bold text-gray-900 dark:text-pink-600">
                    BDT {artwork.price}
                  </span>
          ...
          {recommend.length > 0 && (
            <div className="flex ml-4 w-72 h-screen justify-center items-center">
              ...
              <div className="container w-full">
                <div className="min-h-96  bg-transparent w-full rounded-xl p-2">
