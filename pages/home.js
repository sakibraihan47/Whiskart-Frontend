  ...
  return (
    <>
      <main class="relative h-screen flex items-center px-6 lg:px-32 text-white bg-gradient-to-r from-gray-800 to-purple-900">
        <section class="w-screen md:w-9/12 xl:w-8/12 bg-hero-p h-96 w-full">
          ...
          <a
            ...
            class=" my-6 font-bold text-gray-900 bg-gray-100 hover:bg-pink-300 focus:ring-4 focus:outline-none focus:ring-gray-100 rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 mr-2 mb-2"
          >
            Join Whiskart
          </a>
        </section>
