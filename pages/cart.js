          ...
          <div className="w-3/4 bg-white px-10 py-10 rounded-xl mr-2">
            ...
            <div className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
              <div className="flex w-2/5">
                ...
                <div className="flex flex-col justify-between ml-4 flex-grow">
                  <span className="font-bold text-sm">art 2</span>
                  <span className="text-red-500 text-xs">artist</span>
                  <a
                    href="#"
            ...
            <div className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
              <div className="flex w-2/5">
                ...
                <div className="flex flex-col justify-between ml-4 flex-grow">
                  <span className="font-bold text-sm">art 1</span>
                  <span className="text-red-500 text-xs">artist</span>
                  <a
                    href="#"
                    className="font-semibold hover:text-red-500 text-gray-500 text-xs"
            ...
            <div className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
              <div className="flex w-2/5">
                ...
                <div className="flex flex-col justify-between ml-4 flex-grow">
                  <span className="font-bold text-sm">art 3</span>
                  <span className="text-red-500 text-xs">Artist</span>
                  <a
                    href="#"
                    className="font-semibold hover:text-red-500 text-gray-500 text-xs"
...
//   }
//   const res = await fetch("http://localhost:3002/getcartitems", {
//     method: "GET",
//     headers: {
